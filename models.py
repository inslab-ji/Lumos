...
class NodeClassifier(torch.nn.Module):
    def __init__(self,
                 ...
                 dropout:               dict(help='dropout rate (between zero and one)') = 0.5,
                 x_steps:               dict(help='KProp step parameter for features', option='-kx') = 4,
                 y_steps:               dict(help='KProp step parameter for labels', option='-ky') = 2,
